...
local Get_Files, res = https.request("https://github.com/SourcePrivet/source2/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://github.com/SourcePrivet/source2/master/plugins_/"..file)
if res == 200 then
...
os.execute('wget https://github.com/SourcePrivet/source2/master/alsh.lua') 
os.execute('cd plugins_;wget https://github.com/SourcePrivet/source2/master/plugins_/help_rep.lua') 
sleep(0.5) 
...
if not filess then
os.execute('cd requfiles ;wget https://github.com/SourcePrivet/source2/master/requfiles/JSON.lua') 
dofile('alsh.lua')  
end
local filess = io.open("requfiles/dkjson.lua","r")
if not filess then
os.execute('cd requfiles ;wget https://github.com/SourcePrivet/source2/master/requfiles/dkjson.lua') 
dofile('alsh.lua')  
end
local filess = io.open("requfiles/serpent.lua","r")
if not filess then
os.execute('cd requfiles ;wget https://github.com/SourcePrivet/source2/master/requfiles/serpent.lua') 
dofile('alsh.lua')  
end
local list = devalsh:smembers(DEVRMBO.."usersbot")
for k,v in pairs(list) do
